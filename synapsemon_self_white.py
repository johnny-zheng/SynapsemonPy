...
BLACK, WHITE = 0, 1
#neural net 
net = NetworkReader.readFrom('SynapsemonPie/synapsemon_self_white.xml') 
...
def move_function(board):
    ...
    trainer.train()
    #NetworkWriter.writeToFile(net, 'SynapsemonPie/synapsemon_self_white.xml')
    #NetworkWriter.writeToFile(net, 'SynapsemonPie/synapsemon_self_white_copy.xml') 
    return best_move 
