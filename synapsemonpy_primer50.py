...
def move_function(board):
    ...
    trainer.train()
    NetworkWriter.writeToFile(net, 'SynapsemonPie/synapsemon_primer50.xml')
    NetworkWriter.writeToFile(net, 'SynapsemonPie/synapsemon_primer50_copy.xml')
