...
BLACK, WHITE = 0, 1
#neural net 
net = NetworkReader.readFrom('CheckersMini/synapsemon_self_black_mini_140.xml') 
...
def move_function(board):
    ...
    trainer.train()
    NetworkWriter.writeToFile(net, 'CheckersMini/synapsemon_self_black_mini_140.xml')
    NetworkWriter.writeToFile(net, 'CheckersMini/synapsemon_self_black_mini_140_copy.xml') 
    return best_move 
