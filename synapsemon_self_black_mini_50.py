...
BLACK, WHITE = 0, 1
#neural net 
net = NetworkReader.readFrom('CheckersMini/synapsemon_self_black_mini_50.xml') 
...
def move_function(board):
    ...
    trainer.train()
    NetworkWriter.writeToFile(net, 'CheckersMini/synapsemon_self_black_mini_50.xml')
    NetworkWriter.writeToFile(net, 'CheckersMini/synapsemon_self_black_mini_50_copy.xml') 
    return best_move 
